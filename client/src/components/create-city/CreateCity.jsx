  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 pt-22 pb-10">
      <form
        ...
        className="w-full max-w-2xl rounded-[32px] bg-[#f3ebdd]/95 backdrop-blur-md border border-amber-900/20 shadow-[0_18px_45px_rgba(0,0,0,0.35)] px-12 py-10 space-y-8"
      >
        {/* Letter header */}
