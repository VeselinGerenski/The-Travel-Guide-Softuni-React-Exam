...
export default function Header() {
    return (
        ...
        <header className="absolute inset-x-0 top-0 z-50 text-white bg-gradient-to-b from-black/60 via-black/10 to-transparent">
            ...
            {/* Full width nav bar */}
            <nav className="w-full flex items-center justify-between px-10 py-3 -mt-4 font-['Playfair_Display']">
                ...
                <div className="hidden lg:block text-3xl font-semibold tracking-wide ml-6">
                    <Link to="/login" className="ink-link inline-block flex items-center gap-2 hover-scale">
                        Login →
                    </Link>
                </div>
